...
| v4_type_pe_best | 5 | 0.5959 | 0.3525 | 0.961 | 0.3525 |
| baseline | 6 | 0.5902 | 0.3421 | 0.9625 | 0.3421 |
| v4_bias_rec_best | 7 | 0.5781 | 0.3223 | 0.9619 | 0.3223 |
| scconcept_encoded | 8 | 0.5021 | 0.2018 | 0.9527 | 0.2018 |

## Overall by dataset and correction method

| dataset / correction_method | baseline | minus | scGPT_human | scconcept | scconcept_encoded | v4_bias_rec_best | v4_plain_best | v4_type_pe_best |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Immune_Human / linear_residual | 0.561±0.002 | **0.583±0.004** | 0.573±0.003 | 0.533±0.005 | 0.409±0.000 | 0.544±0.002 | 0.571±0.005 | 0.567±0.004 |
| Immune_Human / none | 0.535±0.002 | **0.568±0.002** | 0.554±0.007 | 0.546±0.001 | 0.379±0.001 | 0.521±0.003 | 0.552±0.006 | 0.541±0.007 |
| PBMC_10K / linear_residual | 0.633±0.000 | 0.644±0.000 | 0.642±0.000 | **0.659±0.000** | 0.610±0.000 | 0.623±0.000 | 0.647±0.001 | 0.638±0.000 |
| PBMC_10K / none | 0.633±0.001 | 0.642±0.000 | 0.641±0.000 | **0.664±0.012** | 0.611±0.000 | 0.624±0.000 | 0.647±0.001 | 0.637±0.000 |

## AvgBIO by dataset and correction method

| dataset / correction_method | baseline | minus | scGPT_human | scconcept | scconcept_encoded | v4_bias_rec_best | v4_plain_best | v4_type_pe_best |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Immune_Human / linear_residual | 0.282±0.004 | **0.309±0.006** | 0.293±0.005 | 0.255±0.008 | 0.065±0.001 | 0.255±0.003 | 0.294±0.008 | 0.288±0.006 |
| Immune_Human / none | 0.257±0.003 | **0.301±0.003** | 0.280±0.012 | 0.257±0.001 | 0.005±0.001 | 0.233±0.004 | 0.288±0.010 | 0.276±0.011 |
| PBMC_10K / linear_residual | 0.414±0.000 | 0.432±0.001 | 0.426±0.000 | **0.443±0.000** | 0.369±0.000 | 0.400±0.000 | 0.439±0.002 | 0.424±0.000 |
| PBMC_10K / none | 0.415±0.001 | 0.430±0.000 | 0.424±0.001 | **0.452±0.020** | 0.369±0.000 | 0.401±0.000 | 0.438±0.001 | 0.422±0.000 |

## AvgBATCH by dataset and correction method

| dataset / correction_method | baseline | minus | scGPT_human | scconcept | scconcept_encoded | v4_bias_rec_best | v4_plain_best | v4_type_pe_best |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Immune_Human / linear_residual | 0.979±0.000 | **0.994±0.000** | 0.992±0.000 | 0.950±0.000 | 0.925±0.000 | 0.978±0.000 | 0.986±0.000 | 0.987±0.000 |
| Immune_Human / none | 0.951±0.000 | 0.967±0.000 | 0.964±0.000 | **0.978±0.000** | 0.940±0.000 | 0.954±0.000 | 0.949±0.000 | 0.938±0.000 |
| PBMC_10K / linear_residual | 0.960±0.000 | 0.962±0.000 | 0.966±0.000 | **0.982±0.000** | 0.972±0.000 | 0.958±0.000 | 0.960±0.000 | 0.960±0.000 |
| PBMC_10K / none | 0.960±0.000 | 0.960±0.000 | 0.967±0.000 | **0.983±0.000** | 0.973±0.000 | 0.958±0.000 | 0.960±0.000 | 0.960±0.000 |
